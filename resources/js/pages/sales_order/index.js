  ...
  target.DataTable({
    ...
    columns: [
      ...
      { 
        data: 'id',
        render(data, type, row) {
          return `<input type="text" class="form-control" id="color_${row.id}" data-id="${row.item_id}" name="color" value="${row.color}">`
        }
      },
      { 
        data: 'id',
        render(data, type, row) {
          return `<input type="text" class="form-control" id="note_${row.id}" data-id="${row.item_id}" name="note" value="${row.note}">`
        }
      },
      { 
        data: 'id',
