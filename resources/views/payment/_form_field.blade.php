<div class="row mb-4">
    <div class="col-sm-4">
        <div class="form-group">
            <label class="c-form--label" for="sales_order_origin">Payment</label>
            <select class="form-control select2" id="payment_id" name="payment_id" required>
                <option></option>
            </select>
...
<h2 class="c-form--title">Payment Data</h2>
<div class="row">
    <div class="col-sm-4">
        <div class="form-group">
